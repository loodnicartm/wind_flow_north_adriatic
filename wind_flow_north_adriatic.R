...
my_key <- "0a09c32d-13b3-4fcf-9286-5cae0e59382b"
...
# 9.964600,40.705628,26.784668,46.830134

xmin <- 9.964600
ymin <- 40.705628
xmax <- 26.784668
ymax <- 46.830134
target <- "wind-sarajevo.nc"
path <- getwd()
...
wind_plot <- ggplot(
  ...
  labs(
    title = "Wind Flow Over Northern Adriatic Sea",
    subtitle = "ERA5 10m winds - April 24, 2025",
    caption = "Data: copernicus ERA5 | Author: Tarik Medošević"
  ) +
  theme_minimal() +
  theme(
...
gganimate::anim_save(
  "wind_flow_sarajevo.gif", wind_gif
)
